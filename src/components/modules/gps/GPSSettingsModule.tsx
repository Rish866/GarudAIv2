...
export default function GPSSettingsModule() {
  ...
  const [mappedVehicles] = useState<MappedVehicle[]>([
    ...
    { vehicle_id: 'veh_004', vehicle_reg: 'GJ-05-GH-3456', device_id: 'ITRI-DEV-78904', status: 'active' },
    { vehicle_id: 'veh_005', vehicle_reg: 'RJ-14-JK-7890', device_id: 'ITRI-DEV-78905', status: 'inactive' },
