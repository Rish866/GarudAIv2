...
const seedPayments: Payment[] = [
  { id: 'pay_001', company_id: COMPANY_ID, invoice_id: 'inv_002', customer_id: 'cust_005', customer_name: 'Maruti Suzuki India', amount: 188490, payment_mode: 'bank_transfer', reference_number: 'NEFT-2025070712345', payment_date: '2025-07-07', tds_amount: 3660, status: 'cleared', created_at: '2025-07-07T11:00:00Z' },
  { id: 'pay_002', company_id: COMPANY_ID, invoice_id: 'inv_003', customer_id: 'cust_002', customer_name: 'Reliance Industries', amount: 50000, payment_mode: 'bank_transfer', reference_number: 'RTGS-2025070567890', payment_date: '2025-07-05', tds_amount: 1000, status: 'cleared', created_at: '2025-07-05T15:00:00Z' },
];

const seedExpenses: Expense[] = [
  { id: 'exp_001', company_id: COMPANY_ID, trip_id: 'trip_001', vehicle_id: 'veh_001', vehicle_reg: 'MH-12-AB-1234', category: 'diesel', amount: 12000, date: '2025-07-08', description: 'Diesel fill - Pune to Mumbai trip', paid_to: 'HP Petrol Pump, Lonavala', payment_mode: 'fuel_card', approved: true, created_at: '2025-07-08T06:30:00Z' },
  { id: 'exp_002', company_id: COMPANY_ID, trip_id: 'trip_002', vehicle_id: 'veh_002', vehicle_reg: 'MH-12-CD-5678', category: 'toll', amount: 4500, date: '2025-07-07', description: 'Toll charges Mumbai-Hyderabad NH-44', paid_to: 'Various toll plazas', payment_mode: 'fastag', approved: true, created_at: '2025-07-07T08:00:00Z' },
  { id: 'exp_003', company_id: COMPANY_ID, trip_id: 'trip_001', vehicle_id: 'veh_001', vehicle_reg: 'MH-12-AB-1234', category: 'driver_bata', amount: 800, date: '2025-07-08', description: 'Driver daily allowance', paid_to: 'Suresh Kumar', payment_mode: 'cash', approved: true, created_at: '2025-07-08T07:00:00Z' },
  { id: 'exp_004', company_id: COMPANY_ID, vehicle_id: 'veh_005', vehicle_reg: 'RJ-14-JK-7890', category: 'repair', amount: 35000, date: '2025-07-08', description: 'Engine overhaul and clutch plate replacement', paid_to: 'Sharma Auto Works, Jaipur', payment_mode: 'bank', approved: true, created_at: '2025-07-08T10:00:00Z' },
  { id: 'exp_005', company_id: COMPANY_ID, trip_id: 'trip_005', vehicle_id: 'veh_003', vehicle_reg: 'MH-14-EF-9012', category: 'toll', amount: 8200, date: '2025-07-02', description: 'Toll charges Pune-Delhi NH-48/NH-44', paid_to: 'Various toll plazas', payment_mode: 'fastag', approved: true, created_at: '2025-07-02T05:00:00Z' },
  { id: 'exp_006', company_id: COMPANY_ID, category: 'salary', amount: 125000, date: '2025-07-01', description: 'Monthly driver salaries - July 2025', paid_to: 'All drivers', payment_mode: 'bank', approved: true, created_at: '2025-07-01T12:00:00Z' },
  { id: 'exp_007', company_id: COMPANY_ID, category: 'office', amount: 15000, date: '2025-07-01', description: 'Office rent - July 2025', paid_to: 'Property Owner', payment_mode: 'bank', approved: true, created_at: '2025-07-01T10:00:00Z' },
];

const seedFuelEntries: FuelEntry[] = [
  { id: 'fuel_001', company_id: COMPANY_ID, vehicle_id: 'veh_001', vehicle_reg: 'MH-12-AB-1234', driver_id: 'drv_001', driver_name: 'Suresh Kumar', trip_id: 'trip_001', date: '2025-07-08', litres: 120, rate: 95.5, amount: 11460, odometer: 145100, station: 'HP Petrol Pump, Lonavala', mileage: 4.2, created_at: '2025-07-08T06:30:00Z' },
  { id: 'fuel_002', company_id: COMPANY_ID, vehicle_id: 'veh_002', vehicle_reg: 'MH-12-CD-5678', driver_id: 'drv_002', driver_name: 'Ramesh Yadav', trip_id: 'trip_002', date: '2025-07-07', litres: 200, rate: 94.8, amount: 18960, odometer: 198200, station: 'Indian Oil, Pune-Mumbai Expressway', mileage: 3.8, created_at: '2025-07-07T05:45:00Z' },
  { id: 'fuel_003', company_id: COMPANY_ID, vehicle_id: 'veh_006', vehicle_reg: 'KA-01-LM-2345', driver_id: 'drv_005', driver_name: 'Manoj Reddy', trip_id: 'trip_004', date: '2025-07-06', litres: 150, rate: 96.2, amount: 14430, odometer: 43050, station: 'BPCL, Bangalore-Hubli Highway', mileage: 4.5, created_at: '2025-07-06T07:00:00Z' },
];

const seedMaintenance: MaintenanceRecord[] = [
  { id: 'maint_001', company_id: COMPANY_ID, vehicle_id: 'veh_005', vehicle_reg: 'RJ-14-JK-7890', type: 'repair', description: 'Engine overhaul - excessive smoke and power loss', date: '2025-07-08', odometer: 234560, cost: 35000, vendor: 'Sharma Auto Works, Jaipur', next_due_date: '2025-10-08', next_due_km: 254560, status: 'in_progress', created_at: '2025-07-08T09:00:00Z' },
  { id: 'maint_002', company_id: COMPANY_ID, vehicle_id: 'veh_001', vehicle_reg: 'MH-12-AB-1234', type: 'preventive', description: 'Scheduled oil change and filter replacement', date: '2025-07-15', odometer: 145000, cost: 8500, vendor: 'Tata Authorized Service, Pune', next_due_date: '2025-10-15', next_due_km: 160000, status: 'scheduled', created_at: '2025-07-05T14:00:00Z' },
  { id: 'maint_003', company_id: COMPANY_ID, vehicle_id: 'veh_002', vehicle_reg: 'MH-12-CD-5678', type: 'tyre', description: 'Rear tyre replacement - 2 tyres', date: '2025-07-03', odometer: 197800, cost: 42000, vendor: 'MRF Tyre Zone, Pune', next_due_km: 247800, status: 'completed', created_at: '2025-07-03T11:00:00Z' },
];
...
const seedEnquiries: Enquiry[] = [
  { id: 'enq_001', company_id: COMPANY_ID, customer_id: 'cust_004', customer_name: 'UltraTech Cement', origin: 'Rajashree Nagar, Karnataka', destination: 'Chennai, Tamil Nadu', material: 'Cement Bags', vehicle_type: 'truck', weight_tons: 25, loading_date: '2025-07-12', target_rate: 55000, status: 'new', created_at: '2025-07-09T09:00:00Z' },
...
export const useStore = create<StoreState>()(
  ...
  updateTripStatus: (id, status) => set((state) => ({ trips: state.trips.map((t) => t.id === id ? { ...t, status } : t) })),
