...
export const useStore = create<StoreState>()(
  ...
  addVehicle: (vehicle) => set((state) => ({ vehicles: [...state.vehicles, { ...vehicle, branch_id: vehicle.branch_id || state.activeBranch }] })),
  ...
  addDriver: (driver) => set((state) => ({ drivers: [...state.drivers, { ...driver, branch_id: driver.branch_id || state.activeBranch }] })),
  ...
  addCustomer: (customer) => set((state) => ({ customers: [...state.customers, { ...customer, branch_id: customer.branch_id || state.activeBranch }] })),
  updateCustomer: (id, updates) => set((state) => ({ customers: state.customers.map((c) => c.id === id ? { ...c, ...updates } : c) })),
  addTrip: (trip) => set((state) => ({ trips: [...state.trips, { ...trip, branch_id: trip.branch_id || state.activeBranch }] })),
  ...
  addInvoice: (invoice) => set((state) => ({ invoices: [...state.invoices, { ...invoice, branch_id: invoice.branch_id || state.activeBranch }] })),
  addPayment: (payment) => set((state) => ({ payments: [...state.payments, { ...payment, branch_id: payment.branch_id || state.activeBranch }] })),
  ...
  addMaintenance: (record) => set((state) => ({ maintenance: [...state.maintenance, { ...record, branch_id: record.branch_id || state.activeBranch }] })),
  addEnquiry: (enquiry) => set((state) => ({ enquiries: [...state.enquiries, { ...enquiry, branch_id: enquiry.branch_id || state.activeBranch }] })),
